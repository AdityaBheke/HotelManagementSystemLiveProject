<%@page import="com.aditya.Hotel_Management_System.dao.RoomRepo"%>
<%@page import="com.aditya.Hotel_Management_System.entity.Room"%>
<%@page import="java.util.ArrayList"%>
<%@page import="org.springframework.beans.factory.annotation.Autowired"%>
<%@page import="com.aditya.Hotel_Management_System.service.RoomService"%>
...
<body>
	...
	<script>
	if(<%=availableRooms %> ==0)
	window.alert("Sorry all rooms are booked !!!");										//Showing alert box if all rooms are booked.
	</script>
	<div class="header">
	...
	<div class="container">
		<form id="form" action="checkin" method="get">
			<h2>Check In</h2>
			<div class="row">
				<div class="col-25">
			...
			<br>
			<div class="row">
				<input type="submit" onclick="confirmation()" value="Check In">
			</div>
		</form>
	</div>
	<script>
	var f = document.getElementById('form');
		function confirmation() {
			...
			let k = <%=availableRooms%>;
			if(f.checkValidity()){										//Checking if all fields of form are filled or not.
			if (ar <= k) {												//Checking if given number of rooms is less than available rooms.
